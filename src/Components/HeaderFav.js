...
const HeaderFav = ({totalArtworks, personalFav}) => {
    ...
    return (
        <div>
            <h1 className="md:block hidden text-center text-4xl md:text-6xl font-bold mt-5 ">
                My A.I. Art Gallery
            </h1>
            <div className="md:flex hidden  h-8 justify-center items-center mx-auto">
            ...
            <div className="md:w-1/2 mx-auto md:mt-3 md:mb-5 mt-5 mb-2 h-10 flex justify-center">
                <Link to="/"
                    ...
                    <span className="md:block hidden font-[Nunito]">
                        Accueil
                    </span>
                </Link>
                <Link to="/favorites"
                      className={`${personalFav.length === 0 ? "" : "border-[crimson] hover:text-[crimson]"} md:flex hidden w-1/6 border rounded-xl flex items-center justify-center px-3 mx-3 hover:bg-white hover:text-black`}>
